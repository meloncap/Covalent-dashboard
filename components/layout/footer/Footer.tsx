  ...
  return (
    <footer className="px-3 py-8 text-gray-500 transition-colors duration-200 bg-white dark:bg-gray-800 text-2 dark:text-gray-200">
      <div className="flex flex-col">
        <div className="h-px mx-auto rounded-full lg:hidden mt-7 w-11"></div>
        <div className="flex flex-col mt-4 lg:mt-0 lg:flex-row">
          <nav className="flex flex-col items-center justify-center flex-1 border-gray-100 lg:items-end lg:border-r lg:pr-5">
            <a
              aria-current="page"
              target="_blank"
              href={confluxLink}
          ...
          <div className="h-px mx-auto mt-4 rounded-full lg:hidden w-11"></div>
          <div className="flex items-center justify-center flex-1 mt-4 border-gray-100 lg:mt-0 lg:border-r">
            <a
              target="_blank"
          ...
          <div className="h-px mx-auto mt-4 rounded-full lg:hidden w-11 "></div>
          <div className="flex flex-col items-center justify-center flex-1 mt-7 lg:mt-0 lg:items-start lg:pl-5">
            <span className="">© 2022</span>
            <span className="mt-7 lg:mt-1">
              Created by{" "}
              <a
