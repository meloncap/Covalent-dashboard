      ...
      <div className="relative z-20 flex flex-col justify-center h-full px-3 mx-auto flex-center">
        <div className="relative flex items-center w-full pl-1 lg:max-w-68 sm:pr-2 sm:ml-0">
          <div className="container relative left-0 z-50 flex w-3/4 h-full">
            <form
              className="flex items-center w-1/2 gap-4 ml-4"
              noValidate
            ...
            >
              ...
              />
              {addressInput && <Button type="submit" label="Search" />}
            </form>
          </div>

          <div className="relative flex items-center justify-end w-1/4 sm:mr-0 sm:right-auto">
            <Select
